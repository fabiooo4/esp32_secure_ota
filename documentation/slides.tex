...
Gli aggiornamenti OTA permettono di:
\begin{itemize}
  \item Aggiornare il firmware senza dover collegare il dispositivo ad un computer.
  \item Verificare il corretto funzionamento del nuovo firmware
\end{itemize}
...
\end{itemize}
Il nuovo firmware viene scritto nella partizione \texttt{ota} non attiva.
Se l'aggiornamento è avvenuto con successo, la partizione \texttt{ota\_data}
...
L'App Rollback permette di tornare ad una versione precedente del firmware per
garantire la funzionalità del dispositivo se la nuova
versione non funziona correttamente .
...
\begin{enumerate}
  ...
  \begin{itemize}
    ...
    \item In modalità \texttt{release}, il second stage bootloader abilita i bit degli eFuse \\
