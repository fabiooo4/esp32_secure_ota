...
\end{lstlisting}
    Siccome verrà attivata la Flash Encryption, non è necessario usare anche la NVS Encryption.
...
in poi bisogna flashare soltanto immagini crittografate sul dispositivo. Per aggiornare
l'applicazione bisogna prima crittografarla usando il seguente comando:
\begin{lstlisting}
