...
idf.py flash monitor
\end{lstlisting}
    per buildare e flashare la partition table e l'applicazione principale.
    L'immagine verrà firmata utilizzando la chiave specificata nel passo \ref{secure_boot_key_path}.
    \textbf{Nota:} il comando \texttt{idf.py flash} non include il bootloader
    quando il Secure Boot è abilitato, quindi bisogna flasharlo separatamente come
